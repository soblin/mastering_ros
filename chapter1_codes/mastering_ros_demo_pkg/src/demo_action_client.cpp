...
int main(int argc, char **argv){
     ...
     * during this function, this client communicates with the server and wait for success message.
     * the important thing is that this node doesnot ensure the connection with the server.
     */
