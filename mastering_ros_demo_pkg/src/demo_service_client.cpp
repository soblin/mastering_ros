...
int main(int argc, char **argv){
    ...
    ros::ServiceClient demo_service_client_node = node_obj.serviceClient<mastering_ros_demo_pkg::demo_service>("demo_service_server_service");

    ros::Rate loop_rate(10);
    int counter = 1;
    while(ros::ok()){
        mastering_ros_demo_pkg::demo_service srv;
        //counterの数字がnabeatsuかどうか
